...
function show_wysiwyg_editor(
    ...
    /* Define all extra CKEditor plugins here. This version contains the image2 plugin, to enable it, add simply image2 to the extraPlugins list */
    ...
    $ckeditor->config['removePlugins'] = 'wsc,link,save,iframe';
