...
function show_wysiwyg_editor(
     ...
     */
	$ckeditor->config['extraPlugins'] = 'wbdroplets,wblink,wbsave,wbshybutton,autolink,ckawesome,codemirror,image2,lineutils,oembed,textselection,widgetselection,syntaxhighlight';
